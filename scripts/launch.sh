...
gnome-terminal --tab --title='Client Sim'         -- $SIM_BIN/nos3-single-simulator client_sim
gnome-terminal --tab --title='Server Sim'         -- $SIM_BIN/nos3-single-simulator server_sim
