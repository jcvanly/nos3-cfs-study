 ...
 *
 * Purpose:
 * Extra scaffolding functions for the client_app unit test
 *
 * Notes:
...
#ifndef UT_CLIENT_APP_H
#define UT_CLIENT_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "CLIENT_APP_Data_t" typedef.
 */
#include "client_app.h"

/*
 * Allow UT access to the global "CLIENT_APP_Data" object.
 */
//extern CLIENT_AppData_t CLIENT_APP_Data;

#endif /* UT_CLIENT_APP_H */
