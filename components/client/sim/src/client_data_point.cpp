...
namespace Nos3
{
    ...
    ClientDataPoint::ClientDataPoint(double count)
    {
    ...
    ClientDataPoint::ClientDataPoint(int16_t spacecraft, const boost::shared_ptr<Sim42DataPoint> dp) : _dp(*dp), _sc(spacecraft)
    {
